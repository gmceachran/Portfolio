...
export function Header() {
  ...
  return (
    <header className="w-full border-b bg-white pt-4">
      <div className="container max-w-none flex h-16 items-center justify-between pb-8">
        ...
        <div className="flex items-center space-x-4 pr-4">
          ...
          <div className="flex items-center space-x-2 ml-6">
            <Button variant="ghost" size="sm" asChild className="p-2 text-black hover:bg-gray-100">
              <a href="https://github.com/gmceachran" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            ...
            <Button variant="ghost" size="sm" asChild className="p-2 text-black hover:bg-gray-100">
              <a href="https://www.linkedin.com/in/gabriel-mceachran-535a85351/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
